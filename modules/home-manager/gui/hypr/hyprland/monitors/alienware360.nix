...
MONITOREOF
    ...
    wayland.windowManager.hyprland.extraConfig = ''
      exec-once = sed -i 's/sdr_brightness = [0-9.]*/sdr_brightness = 1.00/' ${config.home.homeDirectory}/.config/hypr/monitors/alienware360.conf
      source = ${config.home.homeDirectory}/.config/hypr/monitors/alienware360.conf
    '';
  };
}
