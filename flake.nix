{
  ...
  inputs = {
    ...
    # evaluate against the pi's 25.11 pkgs: home-manager 26.05's
    # modular-services imports `${pkgs.path}/lib/services/lib.nix`, which does
    # not exist in nixpkgs 25.11. Pin matching 25.11 home-manager for that one
    # host as a bridge. When upstream nixos-raspberrypi moves to nixos-26.05,
    # delete this input and revert hosts/pi-backup-nix/home-manager.nix to
    # home-manager-stable.
