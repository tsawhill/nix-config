  ...
  config = lib.mkIf (cfg.enable && config.wayland.windowManager.hyprland.enable) {
    ...
    xdg.desktopEntries = {
      yarg-43 = {
        ...
        exec = ''hyprctl dispatch exec "[workspace active;float] env DISABLE_MANGOHUD=1 gamescope -W 1920 -H 1440 -w 1920 -h 1440 -- yarc-launcher"'';
        icon = "yarc-launcher";
        type = "Application";
        terminal = false;
        categories = [ "Game" ];
      ...
      yarg-169 = {
        ...
        exec = ''hyprctl dispatch exec "[workspace active;float] env DISABLE_MANGOHUD=1 gamescope -W 2560 -H 1440 -w 2560 -h 1440 -- yarc-launcher"'';
        icon = "yarc-launcher";
        type = "Application";
        terminal = false;
        categories = [ "Game" ];
