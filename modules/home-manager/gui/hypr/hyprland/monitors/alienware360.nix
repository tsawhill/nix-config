...
MONITOREOF
    ...
    wayland.windowManager.hyprland.extraConfig = ''
      exec-once = sed -i 's/sdr_brightness = [0-9.]*/sdr_brightness = 1.00/' $HOME/.config/hypr/monitors/alienware360.conf
      source = $HOME/.config/hypr/monitors/alienware360.conf
    '';
  };
}
